...
public class ArmSubsystem extends ProfiledPIDSubsystem {
  ...
  //COMPONENT 3D POSES PUBLISHERS
  Pose3d superStructurePose = new Pose3d(0.0, 0.0, 0.0, 
                        new Rotation3d(0.0, 0.0, 0.0));

  StructPublisher<Pose3d> superStructurePublisher = 
              NetworkTableInstance.getDefault().getStructTopic("Super Structure Pose", 
  ...
  public void periodic() {
      ...
      //COMPONENT POSE 3D
      superStructurePublisher.set(superStructurePose);
  }
